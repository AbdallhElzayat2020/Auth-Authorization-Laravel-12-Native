...
<div class="container">
    ...
    <div class="footer">
        ...
        <p>This Url is Valid for one time action for <b style="color: red ; font-size: 20px;"> 10 Minutes</b></p>
        <p style="word-break: break-all; white-space: normal;">{{ $loginLink }}</p>
    </div>
</div>
</body>
</html>