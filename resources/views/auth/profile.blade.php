            ...
            <form action="" method="POST" class="mb-6">
                ...
                <div class="flex items-center mb-4">
                    <input type="checkbox" name="logout_other_devices"
                           id="logout_other_devices" {{auth()->user()->logout_other_devices ? 'checked' : ''}}>
                ...
                <div class="flex items-center justify-between p-3 bg-gray-800 rounded-lg border border-gray-700 mb-4">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <div class="text-xs text-gray-500"> {{$session->last_activity}}</div>
                        </div>
                    </div>

                    @if (!$session->is_this_device)
                        <form action="{{ route('logout.session' ,$session) }}" method="post">
                            @csrf
