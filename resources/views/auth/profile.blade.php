        ...
        <div id="profileTab" class="tab-content">
            ...
            <form action="{{ route('profile.update') }}" method="POST" class="mb-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="name" name="name" value="{{auth()->user()->name}}" autocomplete="off"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="email" name="email" value="{{auth()->user()->email}}" autocomplete="off"
                           class="w-full p-3 rounded bg-gray-700 text-gray-100 border border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    @error('email')
                    <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                    @enderror
                ...
                <div class="flex items-center mb-4">
                    <input type="checkbox" name="logout_other_devices"
                           id="logout_other_devices" @checked(old('logout_other_devices', auth()->user()->logout_other_devices))>
        ...
        <div id="passwordTab" class="tab-content hidden">
            ...
            <form action="{{ route('change-password') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" id="new_password" name="new_password" autofocus autocomplete="new-password"
                           class="w-full p-3 rounded bg-gray-700 text-gray-100 border border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    @error('new_password')
                    <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                    @enderror
